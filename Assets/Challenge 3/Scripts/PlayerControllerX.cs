...
public class PlayerControllerX : MonoBehaviour
{
    ...
    private float highestPointAllowedToJump = 10f;
    ...
    void Update()
    {
        isLowEnough = transform.position.y < highestPointAllowedToJump;
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        {
            //4 is been used because the object spawning start from 5 to avoid collision.
